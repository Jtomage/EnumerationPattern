...
/// <summary>
/// Class used to test Json Converter on Enumeration Class
/// </summary>
public class TestData
{
	public WorkflowStatus AuditStatus { get; set; } = WorkflowStatus.NotStarted;

	public WorkflowStatus TPSReportStatus { get; set; } = WorkflowStatus.SubmittedForReview;

	public WorkflowStatus WenisStatus { get; set; } = WorkflowStatus.InReview;
...
/// Enumeration Class
/// </summary>
public class WorkflowStatus : Enumeration<Guid>
{
	...
	private WorkflowStatus(Guid id, string baseText)
		: base(id, baseText)
	{
	}
}